...
import { HomePage, 
  ...
  EditServiceListPage,
  EditServicePage,
  SelectServicePage } from 'components'
    ...
    return (
      <ThemeProvider theme={theme}>
        <Switch>
          ...
          <Route path="/SelectServicePage" component={SelectServicePage} exact/>
          ...
          <Route path="/services/:service/:status" component={StatusServicePage} exact/>
