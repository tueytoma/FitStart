...
class DropdownMenu extends React.Component {
    ...
    render() {
        return(
            <Wrapper>
                <Select value={this.props.value} onChange={this.props.onChange} error={this.props.error}  color={this.props.color} width={this.props.width} height= {this.props.height}>
