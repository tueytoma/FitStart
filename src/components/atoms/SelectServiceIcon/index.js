...
export default class SelectServiceIcon extends React.Component {
  ...
  render() {
    return (
        <SVG fill="#202020" fillOpacity="0.2" color={this.props.color} version="1.1" xmlns="http://www.w3.org/2000/svg" width={this.props.width} height={this.props.height} x="0px" y="0px" viewBox="0 0 29.9 22.9" enableBackground="new 0 0 29.9 22.9" >
            <g id="การสมัคร">
                <g>
