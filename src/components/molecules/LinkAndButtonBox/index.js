...
class LinkAndButtonBox extends React.Component {
    ...
    render() {
        return (
            <Wrapper>
                <LinkStyle size={this.props.sizeLink} to={this.props.to} loginPage={this.props.loginPage} cancleRegis={this.props.cancleRegis}> <p>{this.props.linktext}</p> </LinkStyle> 
