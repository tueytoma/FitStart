        ...
        <InnerWrapper>
            ...
            <FooterBlock>
              ...
              <LRBlock style={{flexFlow: "row", justifyContent: "flex-end"}}>
                <LinkAndButtonBox disabled={!this.state.checkboxPass} onClick={this.createService} to="/" cancelregis={1} color={color} linktext="ยกเลิกการสร้างบริการ" buttontext="สร้างบริการ"/>
              </LRBlock>
            </FooterBlock>
            <Footer color={color} />
        </InnerWrapper>
